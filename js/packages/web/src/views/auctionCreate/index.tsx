  ...
  return (
    <>
      <Row className="call-to-action">
        <h2>List an item</h2>
        <p>
          First time listing on FeatherNFT Store? <a>Read our sellers' guide.</a>
        </p>
      </Row>
  ...
  return (
    ...
    >
      ...
      <div className="waiting-title">
        Your creation is being listed with FeatherNFT...
      </div>
...
const Congrats = (props: {
  ...
  const newTweetURL = () => {
    const params = {
      text: "I've created a new NFT auction on FeatherNFT Store, check it out!",
      url: `${
        window.location.origin
      }/#/auction/${props.auction?.auction.toString()}`,
      hashtags: 'NFT,Crypto,FeatherNFT',
      // via: "Metaplex",
      related: 'FeatherNFT,Solana',
    };
